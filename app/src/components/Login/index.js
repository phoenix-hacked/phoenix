...
const GoogleLogin = () => {
  ...
  const clientID =
    '589382407673-41h26lsu2inntfq22p8llo65o23us6sc.apps.googleusercontent.com';
  useEffect(() => {
        ...
        <div className="wrapper fadeInDown">
          <div id="formContent">
            <div className="fadeIn first bg-primary p-3">
              <img
                src="https://www.cloudfactory.com/hubfs/img/logo/CloudFactory-Logo-245px.png"
                id="icon"
                alt="User Icon"
              />
            ...
            <button
              className="loginBtn loginBtn--google mt-5 mb-5"
              id="customBtn">
              Login with Google
            </button>
            <div id="formFooter" />
